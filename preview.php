...
input.url { -webkit-transition: all 0.7s ease 0s; -moz-transition: all 0.7s ease 0s; -o-transition: all 0.7s ease 0s; transition: all 0.7s ease 0s; }
...
<input class="form-control form-control-sm url" type="text" name="url" value="<?php echo "https://".$_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF']).""; ?>">
